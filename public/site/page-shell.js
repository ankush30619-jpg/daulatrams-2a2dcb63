...
(function () {
  ...
  ann.innerHTML = `<div class="ann-track">
    ...
    <span>Use code <b>powerplus10</b> for Extra 10% off</span>
  ...
  hdr.innerHTML = `<div class="container">
    ...
    <div class="nav-actions">
      ...
      <a class="icon-btn icon-profile" href="/profile" aria-label="My Account"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/></svg></a>
